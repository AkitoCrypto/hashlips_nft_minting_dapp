      ...
      >
        ...
        <ResponsiveWrapper flex={1} style={{ padding: 24 }} test>
          <s.Container flex={1} jc={"center"} ai={"center"}>
            <StyledImg alt={"testexample"} src={"/config/images/testexample.png"} />
          </s.Container>
          <s.SpacerLarge />
          <s.Container
            flex={2}
          ...
          <s.Container flex={1} jc={"center"} ai={"center"}>
            <StyledImg
              alt={"testexample"}
              src={"/config/images/testexample.png"}
        ...
        <s.Container jc={"center"} ai={"center"} style={{ width: "70%" }}>
          ...
          >
            Billionaire Scammers Club is created by Sam Bankrupt Fired. Create this project to buy SBF a McDonald. Zhu Su, Do Kwon and other scammers will be invited to the club.
          </s.TextDescription>
          <s.SpacerSmall />
          <s.TextDescription
            style={{
